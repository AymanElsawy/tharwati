...
Page = header (eyebrow/title/description) + combined Wealth Overview card (Net Worth and Assets Breakdown) + Portfolio Allocation + `AccountsOverviewCard` + `DashboardGoalsCard`.
