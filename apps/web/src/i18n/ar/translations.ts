...
export const ar: Record<TranslationKey, string> = {
  ...
  "pages.analysis.eyebrow": "رؤى للقراءة فقط",
  "pages.analysis.title": "تحليل الثروة",
  "pages.analysis.description":
    "افهم إجمالي ثروتك واكتمال تقييمها وتوزيعها عبر فئات الأصول.",
  "analysis.loading": "جارٍ تحميل تحليل الثروة",
  "analysis.error.title": "تحليل الثروة غير متاح",
  "analysis.error.description":
    "تعذر تحميل أحدث تقييم للثروة. لم تتغير بيانات حساباتك المحفوظة.",
  "analysis.error.retry": "حاول مرة أخرى",
  "analysis.empty.title": "ابدأ ببناء صورة ثروتك",
  "analysis.empty.description":
    "أضف حسابًا لعرض إجمالي قيمة ثروتك وتوزيعها عبر فئات الأصول.",
  "analysis.empty.action": "عرض الحسابات",
  "analysis.value.unavailable": "غير متاح",
  "analysis.coverage.complete": "التقييم مكتمل",
  "analysis.coverage.incomplete": "التقييم غير مكتمل",
  "analysis.classes.openPortfolio": "فتح تحليل المحفظة",
  "analysis.classes.specializedDeferred": "التحليل المتخصص سيأتي لاحقًا",
  "analysis.health.eyebrow": "صحة الثروة",
  "analysis.health.title": "وضع ثروتك الحالي",
  "analysis.health.description":
    "عرض وصفي للتركيز وانكشاف النقد والبنك والالتزامات وجودة التقييم.",
  ...
  "analysis.health.netWealth": "صافي قيمة الثروة كمؤشر مساند",
  "analysis.health.valuation": "جودة التقييم",
  "analysis.health.largestExposure": "أكبر انكشاف",
  "analysis.health.cashExposure": "الانكشاف للنقد والبنك",
  "analysis.health.liabilities": "الالتزامات",
  "analysis.attention.eyebrow": "انتباه",
  "analysis.attention.title": "ملخص الانتباه",
  "analysis.attention.description":
    "إشارات واقعية من تقييم الثروة الحالي دون توصيات أو درجات.",
  "analysis.attention.incompleteTitle": "بعض مدخلات التقييم لم تُحل",
  "analysis.attention.unresolvedPrefix": "يوجد",
  "analysis.attention.unresolvedSuffix":
    "مصدر مطلوب للقيمة أو التحويل لم يُحل. تبقى الإجماليات غير متاحة بدلًا من عرض قيمة جزئية.",
  "analysis.attention.staleTitle": "لقطة التقييم قديمة",
  "analysis.attention.staleDescription":
    "راجع حداثة البيانات قبل الاعتماد على التقييم الحالي في القرارات الحساسة للوقت.",
  "analysis.attention.noneTitle": "لا توجد ملاحظات جوهرية",
  "analysis.attention.noneDescription":
    "لا تظهر بيانات التقييم الحالية حالة تستدعي الانتباه.",
  "analysis.insights.eyebrow": "أدلة عابرة لفئات الأصول",
  "analysis.insights.title": "رؤى أساسية",
  "analysis.insights.description": "حقائق موجزة مستمدة من تقييم ثروتك الحالي.",
  "analysis.insights.category.confidence": "موثوقية البيانات",
  "analysis.insights.category.structure": "هيكل الثروة",
  "analysis.insights.category.liabilities": "الالتزامات",
  "analysis.insights.category.liquidity": "السيولة",
  "analysis.insights.confidence.title": "موثوقية التقييم",
  "analysis.insights.confidence.unresolved": "مصادر التقييم غير المحلولة:",
  "analysis.insights.confidence.stale": "لقطة التقييم قديمة.",
  "analysis.insights.confidence.unavailable": "حداثة التقييم غير متاحة.",
  "analysis.insights.confidence.completeCurrent": "التقييم مكتمل وحديث.",
  "analysis.insights.concentration.title": "التركّز",
  "analysis.insights.concentration.represents": "تمثل",
  "analysis.insights.concentration.ofWealth": "من ثروتك المُقيّمة.",
  "analysis.insights.liabilities.title": "الالتزامات إلى الأصول",
  "analysis.insights.liabilities.prefix": "تمثل الالتزامات",
  "analysis.insights.liabilities.suffix": "من إجمالي الأصول المقيّمة بموثوقية.",
  "analysis.insights.liabilities.unavailable":
    "توجد التزامات، لكن نسبتها من إجمالي الأصول المقيّمة غير متاحة.",
  "analysis.insights.liquidity.title": "حصة النقد والبنك",
  "analysis.insights.liquidity.prefix": "يمثل النقد والبنك",
  "analysis.insights.liquidity.suffix": "من الثروة المقيّمة بموثوقية.",
  "analysis.insights.breadth.title": "اتساع فئات الأصول",
  "analysis.insights.breadth.prefix": "تأتي القيمة الموجبة الموثوقة حاليًا من",
  "analysis.insights.breadth.suffix": "فئات أصول.",
  "analysis.allocation.eyebrow": "هيكل الأصول المتقاطع",
  "analysis.allocation.title": "توزيع الثروة",
  "analysis.allocation.description":
    "عرض مرتب لفئات الأصول الموجبة وقيمها الحالية وحصتها من الأصول المدعومة.",
  "analysis.allocation.chartLabel": "مخطط حلقي لتوزيع الثروة",
  "analysis.allocation.legendLabel": "تفاصيل توزيع الثروة",
  "analysis.allocation.valuedTotal": "إجمالي القيمة المقيّمة حاليًا",
  "analysis.allocation.completeCoverage": "100% من التوزيع المشمول",
  "analysis.allocation.unavailableTitle": "توزيع الثروة غير متاح",
  "analysis.allocation.unavailableDescription":
    "سيظهر التوزيع الكامل بعد حل جميع القيم وعمليات التحويل المطلوبة.",
  "analysis.allocation.empty": "لا توجد قيم أصول موجبة متاحة للتوزيع.",
  "analysis.allocation.contextTitle": "أكبر انكشاف",
  "analysis.allocation.contextPrefix": "أكبر فئة أصول حاليًا هي",
  "analysis.allocation.contextAt": "بنسبة",
  "analysis.targets.eyebrow": "الهيكل المختار",
  "analysis.targets.title": "التوزيع المستهدف والانحراف",
  "analysis.targets.description":
    "قارن الفئات المشاركة ذات التقييم الموثوق بأهدافك المحفوظة وهامش السماح. تُستبعد الفئات المحددة بنسبة 0% من هذه المقارنة.",
  "analysis.targets.edit": "تعديل الهدف",
  "analysis.targets.loading": "جارٍ تحميل التوزيع المستهدف",
  "analysis.targets.loadError": "التوزيع المستهدف غير متاح",
  "analysis.targets.loadErrorDescription": "تعذر تحميل هدفك المحفوظ.",
  "analysis.targets.retry": "حاول مرة أخرى",
  "analysis.targets.empty":
    "حدد توزيعًا مستهدفًا لمقارنة ثروتك المقيمة حاليًا بالهيكل الذي اخترته.",
  "analysis.targets.unavailable": "مقارنة الهدف غير متاحة",
  "analysis.targets.unavailableDescription":
    "يتعذر تقييم إحدى فئات الأصول المشاركة بموثوقية في اللقطة الحالية.",
  "analysis.targets.current": "الحالي",
  "analysis.targets.target": "الهدف",
  "analysis.targets.gap": "الفجوة",
  "analysis.targets.statusLabel": "الحالة",
  "analysis.targets.status.within": "ضمن النطاق المستهدف",
  "analysis.targets.status.above": "أعلى من النطاق المستهدف",
  "analysis.targets.status.below": "أقل من النطاق المستهدف",
  "analysis.targets.largestPrefix": "لديها أكبر انحراف عن الهدف:",
  "analysis.targets.largestAboveTarget": "أعلى من هدفك المختار",
  "analysis.targets.largestBelowTarget": "أقل من هدفك المختار",
  "analysis.targets.largestEquivalent": "ما يعادل تقريبًا",
  "analysis.targets.allWithin":
    "جميع فئات الأصول المشاركة ضمن نطاقاتك المستهدفة المختارة.",
  "analysis.targets.excludedValueSingle":
    "تحتفظ فئة {{classes}} بقيمة حالية موثوقة، لكنها مستبعدة من توزيعك المستهدف المختار.",
  "analysis.targets.excludedValueMultiple":
    "تحتفظ الفئات {{classes}} بقيم حالية موثوقة، لكنها مستبعدة من توزيعك المستهدف المختار.",
  "analysis.targets.editorTitle": "تعديل التوزيع المستهدف",
  "analysis.targets.editorDescription":
    "أدخل نسبة لكل فئة أصول مدعومة ضمن الثروة.",
  "analysis.targets.zeroExclusion":
    "يؤدي هدف 0% إلى استبعاد الفئة وقيمتها الحالية من مقارنة الهدف.",
  "analysis.targets.tolerance": "هامش السماح",
  "analysis.targets.toleranceHelperPrefix": "سيُعامل التوزيع الواقع ضمن",
  "analysis.targets.toleranceHelperSuffix": "من هدفك على أنه ضمن النطاق.",
  ...
  "analysis.targets.toleranceError":
    "يجب أن يكون هامش السماح نسبة من 0% إلى 100% وبحد أقصى 6 منازل عشرية.",
  "analysis.targets.total": "الإجمالي",
  "analysis.targets.totalError": "يجب أن يكون مجموع نسب الأهداف 100% بالضبط.",
  "analysis.targets.save": "حفظ الهدف",
  "analysis.targets.saving": "جارٍ الحفظ…",
  "analysis.targets.saveError": "تعذر حفظ توزيعك المستهدف. حاول مرة أخرى.",
  "analysis.dimensions.eyebrow": "أبعاد التحليل",
  "analysis.dimensions.title": "الهيكل والانكشاف",
  "analysis.dimensions.description": "كيف تتوزع ثروتك اليوم.",
  "analysis.dimensions.unavailable":
    "هذه الأدلة غير متاحة ما دامت تغطية التقييم غير مكتملة.",
  "analysis.diversification.title": "التنويع والتركيز",
  "analysis.diversification.spread": "انتشار فئات الأصول",
  "analysis.diversification.largest": "أكبر انكشاف",
  "analysis.liquidity.title": "السيولة",
  "analysis.liquidity.cashShare": "حصة النقد والبنك من الأصول",
  "analysis.liquidity.cashValue": "قيمة النقد والبنك",
  "analysis.currency.title": "انكشاف العملات",
  "analysis.currency.unavailable": "تفصيل العملات غير متاح",
  "analysis.currency.unavailableDescription":
    "تفاصيل العملات الأصلية غير متاحة في التقييم الحالي.",
  "analysis.quality.eyebrow": "موثوقية البيانات",
  "analysis.quality.title": "جودة التقييم وحداثته",
  "analysis.quality.description":
    "تحقق مما إذا كانت أدلة الثروة مكتملة وحديثة وخالية من مصادر التقييم غير المحلولة.",
  "analysis.quality.coverage": "التغطية",
  "analysis.quality.freshness": "الحداثة",
  "analysis.quality.current": "اللقطة حديثة",
  "analysis.quality.stale": "اللقطة قديمة",
  "analysis.quality.unresolved": "المصادر غير المحلولة",
  "analysis.explorer.eyebrow": "تعمق أكثر",
  "analysis.explorer.title": "استكشف ثروتك",
  "analysis.explorer.description":
    "تحليل المحفظة متاح الآن، والتحليلات المتخصصة الأخرى مخطط لها.",
  "analysis.explorer.noCurrentValue": "لا توجد قيمة حالية",
  ...
  "accounts.records.refundAmount": "مبلغ الاسترداد",
  ...
  "accounts.records.refund": "استرداد",
  "accounts.records.recordRefund": "تسجيل استرداد",
  "accounts.records.cancelRefund": "إلغاء الاسترداد",
