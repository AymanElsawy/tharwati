...
export function normalizeAccountForm(values: AccountFormValues): AccountFormValues {
  return {
    ...values,
    name: values.name.trim(),
    currencyCode: values.currencyCode.trim().toUpperCase() as AccountFormValues["currencyCode"],
