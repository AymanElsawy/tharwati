...
import type { BusinessValuationMethodCode } from "./business-valuation-method"

export const accountTypeOptions = [
  {
    value: "cash",
    labelKey: "accountType.cash",
    creationLabelKey: "accounts.type.cash",
  },
  {
    value: "bank",
    labelKey: "accountType.bank",
    creationLabelKey: "accounts.type.bank",
  },
  {
    value: "brokerage",
    labelKey: "accountType.brokerage",
    creationLabelKey: "accounts.type.brokerage",
  },
  {
    value: "gold",
    labelKey: "accountType.gold",
    creationLabelKey: "accounts.type.gold",
  },
  {
    value: "real_estate",
    labelKey: "accountType.real_estate",
    creationLabelKey: "accounts.type.realEstate",
  },
  {
    value: "business",
    labelKey: "accountType.business",
    creationLabelKey: "accounts.type.business",
  },
  {
    value: "other",
    labelKey: "accountType.other",
    creationLabelKey: "accounts.type.other",
  },
] as const
...
export const purityOtherOption = {
  value: "other",
  labelKey: "accounts.form.purity.other",
} as const
...
export const currencyCodes = currencyOptions.map((option) => option.value) as [
...
export const silverPurityCodes = silverPurityOptions.map(
  (option) => option.value
)
...
export type AccountFormValues = {
  ...
  valuationMethod: BusinessValuationMethodCode | ""
...
export function getBalanceLabelKey(
  ...
  | "accounts.form.startingBalance"
  | "accounts.form.startingCashBalance"
  | "accounts.form.currentValue" {
  if (code === "brokerage") return "accounts.form.startingCashBalance"
  if (code === "real_estate" || code === "business")
    return "accounts.form.currentValue"
