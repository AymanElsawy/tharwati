  ...
  return (
    <div className="divide-y divide-[var(--border-quiet)]" role="status">
      {Array.from({ length: 3 }, (_, index) => (
        <div
          key={index}
          className="grid gap-3 py-4 first:pt-0 last:pb-0 xl:grid-cols-1 2xl:grid-cols-[minmax(0,1fr)_minmax(12rem,0.7fr)_minmax(10rem,0.55fr)] 2xl:items-center"
        >
...
export function DashboardGoalsCard() {
  ...
  return (
    <section
      className="tharwati-card p-5 sm:p-6"
            ...
            {model.goals.map((goal) => {
              ...
              return (
                <li key={goal.id} className="py-4 first:pt-0 last:pb-0">
                  <div className="grid gap-3 sm:grid-cols-[minmax(0,1fr)_minmax(14rem,auto)] xl:grid-cols-1 2xl:grid-cols-[minmax(0,1fr)_minmax(12rem,0.7fr)_minmax(10rem,0.55fr)] 2xl:items-center">
                    <div className="min-w-0">
                      <h3 className="font-semibold break-words">{goal.name}</h3>
                      {goal.target_date ? (
                    ...
                    <div className="flex min-w-0 items-center gap-3 sm:col-span-2 xl:col-span-1 2xl:col-span-1">
                      <span
                      ...
                      <Progress
                        ...
                        value={Number(goal.displayPercent)}
                      />
                    </div>
                  </div>
                </li>
